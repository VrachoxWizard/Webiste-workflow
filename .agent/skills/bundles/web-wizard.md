...
> For building modern, high-performance web apps with React, Next.js, and Tailwind.
...
- **Forms** → Use `form-cro` to maximize completion rates
- **SEO optimization** → Use `seo-audit` for crawlability and ranking improvements
...
- `.agent/skills/nextjs-best-practices/SKILL.md`
- `.agent/skills/tailwind-patterns/SKILL.md`
- `.agent/skills/form-cro/SKILL.md`
