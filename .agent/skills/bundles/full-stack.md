...
- **API design** → Use `api-patterns`
- **Database** → Use `database-design`
- **Next.js routing** → Use `nextjs-app-router-patterns`
- **Auth** → Use `nextjs-supabase-auth`
- **Data fetching** → Use `tanstack-query-expert` + `react-state-management`
- **AI features** → Use `vercel-ai-sdk-expert`
- **Payments** → Use `stripe-integration`
- **Deployment** → Use `vercel-deployment`

## Skill Paths

- `.agent/skills/senior-fullstack/SKILL.md`
- `.agent/skills/frontend-developer/SKILL.md`
- `.agent/skills/frontend-dev-guidelines/SKILL.md`
- `.agent/skills/backend-dev-guidelines/SKILL.md`
- `.agent/skills/nextjs-app-router-patterns/SKILL.md`
- `.agent/skills/nextjs-supabase-auth/SKILL.md`
- `.agent/skills/api-patterns/SKILL.md`
- `.agent/skills/database-design/SKILL.md`
- `.agent/skills/react-state-management/SKILL.md`
- `.agent/skills/tanstack-query-expert/SKILL.md`
- `.agent/skills/vercel-ai-sdk-expert/SKILL.md`
- `.agent/skills/vercel-deployment/SKILL.md`
- `.agent/skills/stripe-integration/SKILL.md`
