...
> For everyone. Install these first. Core skills for planning, quality, and workflow.
...
- **Refactoring** → Use `kaizen` for incremental improvements
- **Saving work** → Use `git-pushing` to commit and push safely

## Skill Paths

- `.agent/skills/concise-planning/SKILL.md`
- `.agent/skills/lint-and-validate/SKILL.md`
- `.agent/skills/git-pushing/SKILL.md`
- `.agent/skills/kaizen/SKILL.md`
